...
try
	...
	$stmt = $db->prepare('INSERT INTO recipe(name,direction,amount,ingredient_id) VALUES (:recipe_name, :direction, :amount, :id);');
	$stmt->bindValue(':recipe_name', $name, PDO::PARAM_STR);
	$stmt->bindValue(':id', $id_string, PDO::PARAM_STR);
